...
const Departments = () => {
  return (
    <div className='min-h-[1099px] flex flex-col  items-center p-4 w-full'>
        <h2 className='text-[#06625f] font-bold mt-10 border-b-2 border-[#06625f] w-fit'>DEPARTMENTS</h2>
        <p className='max-w-[970px] mt-5 font-semibold text-[48px] leading-[57px] mb-20 text-center'>Academic Excellence at Menoufia University</p>
