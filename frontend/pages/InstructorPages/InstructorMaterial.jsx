    ...
    courses.length > 0 ? (
      <div className="md:w-[80%] w-full m-auto mt-10">
        ...
        <div className="flex w-full flex-row flex-wrap gap-4">
          {courses.map((course) => (
            <div
              onClick={() => navigate(`/instructorDashboard/Material/${course.courseId}`)}
              key={course.courseId}
      ...
      <div className="md:w-[80%] w-full m-auto mt-10">
        ...
        <div className="w-[80%] mx-auto h-[2px] bg-gray-200"></div>
        <h3 className="text-xl mx-auto font-semibold mb-4 w-auto mt-10 text-center text-gray-400">
