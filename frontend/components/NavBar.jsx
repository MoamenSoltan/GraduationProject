  ...
  return (
    <div className="flex  px-10 z-50 items-center justify-between shadow-sm  p-2 bg-[#FAFBFB]  ">
      <button
        ...
        className={`hover:bg-gray-200 p-2 text-xl rounded-full hover:cursor-pointer ${
          activeMenu ? "md:ml-[300px] ml-[160px]" : ""
        } `}
      >
        <AiOutlineMenu />
      </button>
      ...
      >
        ...
        <div className="sub-text flex flex-row items-center  ">
          <p>
            Hi, <span className="font-bold">{trimText(name, 10)}</span>{" "}
          </p>
